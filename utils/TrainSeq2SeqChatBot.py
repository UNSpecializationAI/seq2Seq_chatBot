...
class TrainSeq2SeqChatBot:
    def __init__(self, input_vocab_size: int, output_vocab_size: int, encoder_input_data: np.array,
                 decoder_input_data: np.array, decoder_target_data: np.array,
                 epochs: int = 100, batch_size: int = 64, num_neurons: int = 256):
